...
public abstract class MultiLevelListAdapter {
    ...
    /**
     * Gets slidemenu of object's sub-items.
     *
     ...
     *
     * @param dataItems The slidemenu with data items.
     */
    ...
    /**
     * Creates slidemenu of nodes for data items provided to adapter.
     *
    ...
    /**
     * Maps current items hierarchy into flat slidemenu.
     *
     * @return Items flat slidemenu.
     */
    ...
    /**
     * Adds recurrently nodes and their sub-nodes to provided slidemenu.
     *
     * @param result Output parameter with flat slidemenu of items.
     * @param nodes Nodes slidemenu.
     */
    ...
    /**
     * Gets currently displayed slidemenu of items.
     *
     * @return List items.
     */
    ...
    /**
     * Helper class used to display created flat slidemenu of item's using Android's ListView.
     */
