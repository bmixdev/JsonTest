...
public class UnCaughtException implements UncaughtExceptionHandler {
    ...
    public UnCaughtException(Context ctx, UncaughtExceptionHandler defHandler) {
        context = ctx;
        context1 = ctx;
        defaultExceptionHandler = defHandler;
    }
...
/*
        new Thread() {
            ...
            public void run() {
                ...
                builder.setTitle("Возникла неизвестная ошибка");
                builder.create();
                ...
                builder.setPositiveButton("Отправить отчет",
                        new DialogInterface.OnClickListener() {
                            @Override
                            public void onClick(DialogInterface dialog,
                                                int which) {
                ...
                builder.setMessage("Ой! В вашем приложение возникла ошибка!");
                builder.show();
