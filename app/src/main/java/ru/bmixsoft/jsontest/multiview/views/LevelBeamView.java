...
package ru.bmixsoft.jsontest.multiview.views;
    ...
    protected void onDraw(Canvas canvas) {
        ...
        for (int lvl = 0; lvl <= mLevel; lvl++) {
            ...
            if (lvl == mLevel) {
                ...
                // canvas.drawLine(LINE_X, 0, LINE_X, /*canvas.getHeight()/2*/ 10, mLinePaint);
                canvas.drawCircle(LINE_X, canvas.getHeight()/2, canvas.getHeight()/2 * 0.2f, mLinePaint);
            }
        }
    }
