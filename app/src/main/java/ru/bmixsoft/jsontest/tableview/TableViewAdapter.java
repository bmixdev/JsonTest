...
import ru.bmixsoft.jsontest.tableview.holder.CellViewHolder;
import ru.bmixsoft.jsontest.tableview.holder.ColumnHeaderViewHolder;
import ru.bmixsoft.jsontest.tableview.holder.RowHeaderViewHolder;
...
public class TableViewAdapter extends AbstractTableAdapter<ColumnHeader, RowHeader, Cell> {
    ...
    public void onBindCellViewHolder(AbstractViewHolder holder, Object p_jValue, int
        ...
        viewHolder.cell_textview.setText(cell.getShowData());
    ...
    public void onBindColumnHeaderViewHolder(AbstractViewHolder holder, Object p_jValue, int
        ...
        columnHeaderViewHolder.column_header_textview.setText((String) columnHeader.getShowData());
     ...
     *                 different type of viewHolder as a slidemenu_row Header item.
     *
     ...
     * specified position. This method gives you everything you need about a slidemenu_row header item.
     *
     * @param holder   : This is one of your slidemenu_row header ViewHolders that was created on
     *                 ```onCreateRowHeaderViewHolder``` method. In this example we have created
     *                 "RowHeaderViewHolder" holder.
     * @param p_jValue : This is the slidemenu_row header view model located on this Y position. In this
     *                 example, the model class is "RowHeader".
     * @param position : This is the Y (slidemenu_row) position of the slidemenu_row header item.
     *
    ...
    public void onBindRowHeaderViewHolder(AbstractViewHolder holder, Object p_jValue, int
        ...
        // Get the holder to update slidemenu_row header item text
        RowHeaderViewHolder rowHeaderViewHolder = (RowHeaderViewHolder) holder;
        rowHeaderViewHolder.row_header_textview.setText((String)rowHeader.getShowData());
    }
    ...
    public int getRowHeaderItemViewType(int position) {
        // The unique ID for this type of slidemenu_row header item
